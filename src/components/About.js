  ...
  return (
    <div className="about">
      ...
      <p>
        ...
        biased and not based on anyone's opinion, simply providing facts about
        products choosen to be in this blog page.
        <br />
        <br />
        Our website has been rated the best on providing mobile phone
        information, it has been rated, accurate, unbiased, and straight to the
        point. We have received awards since the year 2017, We are simply the
        best to provide you with this service and no one is better equiped to
        this than we are. We value transparency, we provide to you the best and
        the rotten information on mobile phones.
      </p>
    </div>
  );
};
